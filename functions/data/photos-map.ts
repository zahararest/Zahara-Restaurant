...
export const PHOTO_CATALOGUE: PhotoMeta[] = [
  ...
  { key: 'eventsExtra1', filename: 'events-extra-1.jpg', group: 'events', optional: true, aspect: '4 / 5',
    label: 'Events photo 1', where: 'Beside the first note in the longer events section',
    note: 'Empty — the note beside it stays hidden until a photo is here.' },
  { key: 'eventsExtra2', filename: 'events-extra-2.jpg', group: 'events', optional: true, aspect: '4 / 5',
    label: 'Events photo 2', where: 'Beside the second note in the longer events section',
    note: 'Empty — the note beside it stays hidden until a photo is here.' },
  { key: 'eventsExtra3', filename: 'events-extra-3.jpg', group: 'events', optional: true, aspect: '4 / 5',
    label: 'Events photo 3', where: 'Beside the third note in the longer events section',
    note: 'Empty — the note beside it stays hidden until a photo is here.' },
  // The "events we have hosted" gallery. Eight optional frames, each with its
  // own caption in /admin/content → Events. Empty frames are not shown, and
  // the band itself stays hidden until at least one is filled — so this can
  // be filled in one photograph at a time.
  { key: 'eventsPast1', filename: 'events-past-1.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 1', where: 'First frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
  { key: 'eventsPast2', filename: 'events-past-2.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 2', where: 'Second frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
  { key: 'eventsPast3', filename: 'events-past-3.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 3', where: 'Third frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
  { key: 'eventsPast4', filename: 'events-past-4.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 4', where: 'Fourth frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
  { key: 'eventsPast5', filename: 'events-past-5.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 5', where: 'Fifth frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
  { key: 'eventsPast6', filename: 'events-past-6.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 6', where: 'Sixth frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
  { key: 'eventsPast7', filename: 'events-past-7.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 7', where: 'Seventh frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
  { key: 'eventsPast8', filename: 'events-past-8.jpg', group: 'events', optional: true,
    aspect: '4 / 5', mobile: true, mobileAspect: '4 / 5',
    label: 'Past event 8', where: 'Eighth frame of the “events we have hosted” gallery on the Events page',
    note: 'Empty. Upload a photograph from an event you have hosted, then describe it in Content → Events → Events we have hosted.' },
