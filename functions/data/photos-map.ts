...
export type PhotoGroup = 'home' | 'menu' | 'contact' | 'location';
...
export const PHOTO_CATALOGUE: PhotoMeta[] = [
  ...
  // ── CONTACT PAGE ───────────────────────────────────────────────────
  { key: 'contact', filename: 'contact-page.jpg', group: 'contact', fallbackKey: 'interior',
    label: 'Contact photo', where: 'Full-width band on the contact page' },

  // ── LOCATION PAGE ──────────────────────────────────────────────────
  { key: 'location', filename: 'location-page.jpg', group: 'location', fallbackKey: 'interior',
    label: 'Location photo', where: 'Photo beside the address on the location page' },
];
