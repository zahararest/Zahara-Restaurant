...
export const CONTENT_GROUPS: ContentGroup[] = [
  ...
  { title: 'Header', page: 'site',
    ...
    { key: 'header.rooftopSoon', label: 'Venue switch — rooftop badge', role: 'label',
      retired: true,
      hint: 'The old \u201csoon\u201d badge on the rooftop side of the pill. The rooftop is open, so the badge is gone from the site.',
      he: 'בקרוב', en: 'Soon' },
  ] },
  ...
  { title: 'Events page · Events we have hosted', page: 'events',
    note: 'The gallery of past events. A frame appears once you upload its photograph in Images → Events page (“Past event 1–8”); '
        + 'the whole band stays hidden until at least one is there. The caption under each photograph is where you describe the evening.',
    fields: [
    { key: 'events.galleryEyebrow', label: 'Eyebrow', role: 'eyebrow', he: 'מתוך הערבים שלנו', en: 'From our evenings' },
    { key: 'events.galleryHeading', label: 'Heading', role: 'display',
      he: 'אירועים שהתארחו אצלנו.', en: 'Evenings we have hosted.' },
    { key: 'events.galleryLede', label: 'Opening line', role: 'lede', multiline: true,
      hint: 'Optional — a sentence under the heading. Blank leaves the photographs to speak.', he: '', en: '' },
    { key: 'events.past1Caption', label: 'Photo 1 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
    { key: 'events.past2Caption', label: 'Photo 2 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
    { key: 'events.past3Caption', label: 'Photo 3 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
    { key: 'events.past4Caption', label: 'Photo 4 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
    { key: 'events.past5Caption', label: 'Photo 5 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
    { key: 'events.past6Caption', label: 'Photo 6 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
    { key: 'events.past7Caption', label: 'Photo 7 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
    { key: 'events.past8Caption', label: 'Photo 8 — caption', role: 'body', multiline: true,
      hint: 'What this evening was. Leave blank to show the photograph on its own.', he: '', en: '' },
  ] },
  ...
  { title: 'Contact form · Field labels', page: 'contact',
    ...
    { key: 'contact.requiredNote', label: 'Required-fields note', role: 'note',
      hint: 'Explains the * beside Name, Phone and Email — the only three a visitor must fill in.',
      he: '* שדות חובה', en: '* Required fields' },
    { key: 'contact.submit',       label: 'Send button', role: 'button', he: 'שליחת פנייה', en: 'Send message' },
  ] },
  { title: 'Contact form · After sending', page: 'contact',
    note: 'What replaces the form once a visitor has sent it. Say when you will reply — this is the last thing they read before they close the page.',
    fields: [
    { key: 'contact.sentEyebrow', label: 'Eyebrow', role: 'eyebrow', he: 'הפנייה נשלחה', en: 'Message sent' },
    { key: 'contact.sentTitle',   label: 'Heading', role: 'display',
      he: 'תודה — קיבלנו את הפנייה.', en: 'Thank you — we have your message.' },
    { key: 'contact.sentBody',    label: 'When you will reply', role: 'body', multiline: true,
    ...
    { key: 'contact.sentAgain',   label: 'Write-again button', role: 'button',
      he: 'שליחת פנייה נוספת', en: 'Send another message' },
  ] },
